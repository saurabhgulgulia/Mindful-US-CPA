...
const ENTITY_SERVICE_IDS = ["corp-return", "incorporation"];
...
function ClientDashboard({ open, clientName, clientEmail, onClose }) {
  const [view, setView] = React.useState("home");  // "home" | "intake" | "organizer"
      ...
      <header className="dashboard-header">
        <div className="dashboard-header-inner">
          <a href="#" className="brand" aria-label="Mindful US CPA — portal home" onClick={(e) => { e.preventDefault(); setView("home"); }}>
            <img src={window.IMG["logo-mark-splash"]} alt="" className="brand-mark-img" />
          ...
          <nav className="dashboard-nav">
            ...
            <button type="button" className={"dashboard-nav-link" + (view === "organizer" ? " active" : "")} onClick={() => { setOrganizerService(null); setView("organizer"); }}>
            ...
            <a className="dashboard-nav-link" href="#documents" onClick={(e) => e.preventDefault()}>
              <Icon name="folder" size={15} />
              Documents
            </a>
            <a className="dashboard-nav-link" href="#messages" onClick={(e) => e.preventDefault()}>
