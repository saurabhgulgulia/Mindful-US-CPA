...
Object.assign(window, {
  ENTITY_TYPES, ENTITY_TYPE_FORM, PARTNERSHIP_TYPES, ENT_US_STATES,
  ENTITY_MONTHS, ENTITY_DAYS, ACCOUNTING_METHODS, ENTITY_PRIMARY_FORM, YN3,
  EntityField, TextField, DateField, SelectField, YesNoInline, EntitySectionHead, OwnerTable,
  AccountingPeriod, DocUpload,
});
...
Object.assign(window, { EntityDocuments, EntityReview, EntityRefund });
          ...
          {step === 0 && (
            <React.Fragment>
              <div className="organizer-body">
                ...
                <div className="entity-grid">
                  <SelectField label="Which U.S. state is the entity registered in?" full value={active.opState} onChange={(v) => patch({ opState: v })} options={ENT_US_STATES} placeholder="Select state" />
                </div>
